...
public class SpatialHashGrid {
    ...
    public int[] getCellIds(GameObject obj) {
        int x1 = (int)FloatMath.floor(obj.getBounds().lowerLeft.x / cellSize);
        int y1 = (int)FloatMath.floor(obj.getBounds().lowerLeft.y / cellSize);
        int x2 = (int)FloatMath.floor((obj.getBounds().lowerLeft.x + obj.getBounds().width) / cellSize);
        int y2 = (int)FloatMath.floor((obj.getBounds().lowerLeft.y + obj.getBounds().height) / cellSize);
